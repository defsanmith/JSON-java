...
public class JSONObject {
    ...
    static final Writer writeValue(Writer writer, Object value,
        ...
        if (value == null || value.equals(null)) {
            ...
            // JSONString must be checked first, so it can overwrite behaviour of other
            // types below
            Object o;
            try {
    ...
    /**
     * Returns a stream of only the leaf JSON nodes in this object (nodes with
     * primitive values).
     * 
    ...
    /**
     * Returns a stream of only the top-level JSON nodes in this object (not
