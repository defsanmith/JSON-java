...
public class JSONArray implements Iterable<Object> {
     ...
     *
     * @param x                       A JSONTokener instance from which the
     *                                JSONArray is constructed.
     * @param jsonParserConfiguration A JSONParserConfiguration instance that
     *                                controls the behavior of the parser.
     * @throws JSONException If a syntax error occurs during the construction of the
     *                       JSONArray.
     */
    ...
    /**
     * Returns a stream of all JSON nodes in this array, including nested nodes.
     * 
    ...
    /**
     * Returns a stream of only the leaf JSON nodes in this array (nodes with
     * primitive values).
     * 
    ...
    /**
     * Returns a stream of only the top-level JSON nodes in this array (not
     * descending into nested objects or arrays).
     * 
    ...
    /**
     * Convert a JSONArray to a List of objects.
     * Used for converting a JSONArray to a regular Java List for serialization.
     * 
     * @return A Java List containing the elements of the JSONArray
     */
    public List<Object> toList() {
        List<Object> results = new ArrayList<Object>(this.length());
